return {
	...
	s("tmux_helpers", {
		t({
			...
			[[terror() { tmux display -d 0 "#[bg=#{@color_error},fill=#{@color_error},fg=black] 󰭺 Message: $*"; }]],
			[[tsuccess() { tmux display -d 0 "#[bg=#{@color_success},fill=#{@color_success},fg=black] 󰭺 Message: $*"; }]],
		})
	})
}, {}
