		...
		require("kanagawa").setup({
			...
			overrides = function(colors)
				...
				return {
					...
					NoicePopup = { bg = colors.palette.dragonBlack4, fg = colors.palette.dragonRed },
					NoicePopupmenu = { bg = colors.palette.dragonBlack4, fg = colors.palette.dragonRed },
					NoicePopupmenuSelected = { bg = colors.palette.dragonBlack4, fg = colors.palette.dragonRed },
