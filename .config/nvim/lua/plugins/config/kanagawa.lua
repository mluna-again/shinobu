		...
		require("kanagawa").setup({
			...
			overrides = function(colors)
				...
				return {
					...
					BufferLineModifiedSelected = { fg = colors.palette.dragonBlack4, bg = colors.palette.dragonRed },
					BufferLineSelected = { fg = colors.palette.dragonBlack3, bg = colors.palette.dragonRed },
					BufferLineVisible = { fg = colors.palette.dragonBlack4, bg = colors.palette.dragonRed },
					...
					BufferLineBackground = { fg = colors.palette.dragonBlack4 },
					...
					BufferLineIndicator = { fg = colors.palette.dragonBlack4, bg = colors.palette.dragonBlack4 },
					BufferLineIndicatorSelected = { fg = colors.palette.dragonBlack4, bg = colors.palette.dragonBlack4 },
					BufferLineIndicatorVisible = { fg = colors.palette.dragonBlack4, bg = colors.palette.dragonBlack4 },
