		...
		require("kanagawa").setup({
			...
			overrides = function(colors)
				...
				return {
					...
					BufferLineVisible = { fg = colors.palette.dragonRed, bg = colors.palette.dragonBlack3 },
					BufferLine = { fg = colors.palette.dragonRed, bg = colors.palette.dragonBlack3 },
					...
					BufferLineIndicatorVisible = { fg = colors.palette.dragonBlack3, bg = colors.palette.dragonBlack3 },
