...
set -gx FZF_DEFAULT_OPTS '--layout=reverse --prompt=" " --pointer=" " --header-first --color="bg+:#c4b28a,fg+:#1D1C19,gutter:#1D1C19,header:#c4b28a,prompt:#c4b28a,query:#c5c9c5,hl:#c4746e,hl+:#c4746e" --height="-2" --bind ¿:preview-up,-:preview-down --cycle'
