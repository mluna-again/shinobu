...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (window-border                                 (:background sumiInk-1b :foreground sumiInk-2))
  ...
  (italic                                        (:foreground foreground :italic t))
  (bold                                          (:foreground foreground :bold t))
  (bold-italic                                   (:foreground foreground :bold t :italic t))
  (link-visited                                  (:foreground surimiOrange :italic t :background background))
  (link                                          (:foreground carpYellow :italic t :background background))
  (custom-link                                   (:foreground surimiOrange :italic t :background background))
  (highlight                                     (:foreground surimiOrange))

  ;; org-mode
  (org-table                                     (:foreground foreground :background background))
  (org-table-header                              (:foreground background :background foreground
							      :overline t))
  (org-link                                      (:foreground carpYellow :italic t :background background))
  (org-verbatim                                  (:foreground springBlue :background background))
  ...
  (org-level-1                                   (:foreground roninYellow :height 1.5 :overline nil
							      :bold t :background background))
  (org-level-2                                   (:foreground roninYellow :height 1.2 :overline nil
							      :bold t :background background))
